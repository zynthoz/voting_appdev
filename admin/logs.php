...
$search_param = "%$search%";
$stmt = mysqli_prepare($conn, "SELECT l.log_id, u.full_name, l.action, l.datetime FROM tbl_logs l JOIN tbl_users u ON l.user_id = u.user_id WHERE u.full_name LIKE ? OR l.action LIKE ? ORDER BY l.datetime DESC");
